...
const UBG_UNUSUAL_EFFECTS = [
    {
        title: "Pain",
        note: "Standard Pain crate effects.",
        items: [
    ...
    {
        title: "Gems",
        note: "Standard Gems crate effects.",
        items: [
    ...
    {
        title: "Dragon",
        note: "Standard Dragon crate effects.",
        items: [
    ...
    {
        title: "Sci-Fi",
        note: "Standard Sci-Fi crate effects.",
        items: [
    ...
    {
        title: "Anime",
        note: "Standard Anime crate effects.",
        items: [
    ...
    },
    {
        ...
        note: "Halloween 2023 crate effects.",
        items: [
    ...
    {
        title: "Christmas 2024 (Jolly)",
        note: "Showcase GIFs are currently unavailable for this crate's unusual effects.",
        items: []
    },
    {
        title: "Valentine's 2026",
        note: "Special event effects.",
        items: [
    ...
    {
        title: "Limited Universal Effects",
        note: "Special effects that have temporarily been available across multiple crates.",
        items: [
